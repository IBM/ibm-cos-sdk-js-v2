import { requireRequestsFrom } from "@ibm-cos/aws-util-test/src";
import { CodeCatalyst } from "@ibm-cos/client-codecatalyst";
import { DynamoDB } from "@ibm-cos/client-dynamodb";
import { S3 } from "ibm-cos-sdk-v2";
import { fromTemporaryCredentials } from "@ibm-cos/credential-providers";
import { DynamoDBDocument } from "@ibm-cos/lib-dynamodb";
import { STSClient } from "@ibm-cos/nested-clients/sts";
import { AwsSdkFeatures } from "@ibm-cos/types";
