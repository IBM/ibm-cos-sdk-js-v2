import type { AwsHandlerExecutionContext } from "@ibm-cos/types";
import { getUserAgentPrefix } from "@ibm-cos/util-endpoints";
...
export const userAgentMiddleware =
  ...
  async (args: BuildHandlerArguments<any>): Promise<BuildHandlerOutput<Output>> => {
    ...
    const normalUAValue = [
      ...defaultUserAgent.filter((section) => section.startsWith("ibm-cos-sdk")),
      ...customUserAgent,
    ].join(SPACE);
