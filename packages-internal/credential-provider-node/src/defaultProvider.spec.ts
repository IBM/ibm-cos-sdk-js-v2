import { fromEnv } from "@ibm-cos/credential-provider-env";
import { fromIni } from "@ibm-cos/credential-provider-ini";
import { fromProcess } from "@ibm-cos/credential-provider-process";
import { fromSSO } from "@ibm-cos/credential-provider-sso";
import { fromTokenFile } from "@ibm-cos/credential-provider-web-identity";
...
vi.mock("@ibm-cos/credential-provider-env");
vi.mock("@smithy/credential-provider-imds");
vi.mock("@ibm-cos/credential-provider-ini");
vi.mock("@ibm-cos/credential-provider-process");
vi.mock("@ibm-cos/credential-provider-sso");
vi.mock("@ibm-cos/credential-provider-web-identity");
