import { STS, STSExtensionConfiguration } from "@ibm-cos/client-sts";
import * as credentialProviderHttp from "@ibm-cos/credential-provider-http";
import {
  fromCognitoIdentity,
  ...
  fromTokenFile,
  fromWebToken,
} from "@ibm-cos/credential-providers";
import { assumeRoleArns, MockNodeHttpHandler } from "@ibm-cos/credential-providers/tests/_test-lib";
