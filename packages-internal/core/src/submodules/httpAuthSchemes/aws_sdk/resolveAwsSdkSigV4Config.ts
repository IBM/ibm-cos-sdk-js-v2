...
import type { AttributedAwsCredentialIdentity, MergeFunctions } from "@ibm-cos/types";
import {
  ...
  if (credentials) {
    ...
    if (credentialDefaultProvider) {
      ...
      credentialsProvider = async () => {
        throw new Error(
          "@ibm-cos/core::resolveAwsSdkSigV4Config - `credentials` not provided and no credentialDefaultProvider was configured."
        );
      };
    }
  }
