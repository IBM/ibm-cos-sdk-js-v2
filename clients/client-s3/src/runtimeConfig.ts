...
import { emitWarningIfUnsupportedVersion as awsCheckVersion, NODE_AUTH_SCHEME_PREFERENCE_OPTIONS } from "@ibm-cos/core";
import { defaultProvider as credentialDefaultProvider } from "@ibm-cos/credential-provider-node";
import { NODE_USE_ARN_REGION_CONFIG_OPTIONS } from "@ibm-cos/middleware-bucket-endpoint";
import {
...
import { NODE_DISABLE_S3_EXPRESS_SESSION_AUTH_OPTIONS } from "@ibm-cos/middleware-sdk-s3";
import { ChecksumConstructor as __ChecksumConstructor, HashConstructor as __HashConstructor } from "@ibm-cos/types";
import { createDefaultUserAgentProvider, NODE_APP_ID_CONFIG_OPTIONS } from "@ibm-cos/util-user-agent-node";
import {
