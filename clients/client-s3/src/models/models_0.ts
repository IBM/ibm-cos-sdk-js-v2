...
export interface AbortMultipartUploadRequest {
   ...
   * <p>Note: To supply the Multi-region Access Point (MRAP) to Bucket, you need to install the "@ibm-cos/signature-v4-crt" package to your project dependencies.
 ...
 * @public
 */
export interface AddLegalHoldInput {
  Bucket: string | undefined;
  Key: string | undefined;
 ...
 * @public
 */
export interface DeleteLegalHoldInput {
  Bucket: string | undefined;
  Key: string | undefined;
  RetentionLegalHoldId: string | undefined;
}
 ...
 * @public
 */
export interface GetBucketProtectionConfigurationInput {
  /**
   * <p>Bucket name</p>
   * <p>Note: To supply the Multi-region Access Point (MRAP) to Bucket, you need to install the "@ibm-cos/signature-v4-crt" package to your project dependencies.
   * For more information, please go to https://github.com/aws/aws-sdk-js-v3#known-issues</p>
 ...
 * @public
 */
export interface DefaultRetentionPeriod {
  Days: number | undefined;
}
 ...
 * @public
 */
export interface MaximumRetentionPeriod {
  Days: number | undefined;
}
 ...
 * @public
 */
export interface MinimumRetentionPeriod {
  Days: number | undefined;
}
...
export interface GetBucketProtectionConfigurationOutput {
   ...
   * @public
   */
  MinimumRetention?: MinimumRetentionPeriod | undefined;

  /**
   * <p>Default retention period.</p>
   * @public
   */
  DefaultRetention?: DefaultRetentionPeriod | undefined;

  /**
   * <p>Maximum retention period.</p>
   * @public
   */
  MaximumRetention?: MaximumRetentionPeriod | undefined;

  /**
   * <p>Indicates whether permanent retention is enabled.</p>
   * @public
   */
  EnablePermanentRetention?: boolean | undefined;

  /**
   * <p>IBM Protection Management State.</p>
   * @public
   */
  IbmProtectionManagementState?: string | undefined;
}
...
export interface GetObjectOutput {
   ...
   * @public
   */
  TemporaryCopyStorageClass?: string | undefined;
   ...
   * @public
   */
  RetentionLegalHoldCount?: number | undefined;
...
export interface HeadBucketOutput {
   ...
   * @public
   */
  IBMSSEKPEnabled?: boolean | undefined;
 ...
 * @public
 */
export interface ListBucketReplicationFailuresInput {
  /**
   * <p>Bucket name</p>
   * <p>Note: To supply the Multi-region Access Point (MRAP) to Bucket, you need to install the "@ibm-cos/signature-v4-crt" package to your project dependencies.
   * For more information, please go to https://github.com/aws/aws-sdk-js-v3#known-issues</p>
   ...
   * @public
   */
  FirstSyncAttemptedBefore?: string | undefined;
...
export interface ReplicationFailureEntry {
   ...
   * @public
   */
  SyncFailureCause?: string | undefined;
}
...
export interface ListBucketReplicationFailuresOutput {
   ...
   * @public
   */
  Contents: ReplicationFailureEntry[] | undefined;
}
...
export interface ListLegalHoldsInput {
  Bucket: string | undefined;
  Key: string | undefined;
  MirrorDestination?: string | undefined;
}
...
export interface ListLegalHoldsOutput {
  ...
  LegalHolds?: LegalHoldEntry[] | undefined;
  RetentionPeriod?: number | undefined;
  RetentionPeriodExpirationDate?: Date | undefined;
}
 ...
 * @public
 */
export interface PutBucketProtectionConfigurationInput {
  /**
   * <p>Bucket name</p>
   * <p>Note: To supply the Multi-region Access Point (MRAP) to Bucket, you need to install the "@ibm-cos/signature-v4-crt" package to your project dependencies.
   * For more information, please go to https://github.com/aws/aws-sdk-js-v3#known-issues</p>
   ...
   * @public
   */
  ProtectionConfiguration: ProtectionConfiguration | undefined;
}
 ...
 * @public
 */
export interface PutBucketReplicationReattemptInput {
  /**
   * <p>Bucket name</p>
   * <p>Note: To supply the Multi-region Access Point (MRAP) to Bucket, you need to install the "@ibm-cos/signature-v4-crt" package to your project dependencies.
   * For more information, please go to https://github.com/aws/aws-sdk-js-v3#known-issues</p>
 ...
 * @public
 */
export interface PutBucketReplicationReattemptOutput {}
