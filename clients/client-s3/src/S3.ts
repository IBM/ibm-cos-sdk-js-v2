...
} from "./commands/AddLegalHoldCommand";
import {
...
} from "./commands/DeleteLegalHoldCommand";
import {
  DeleteObjectCommand,
...
} from "./commands/GetBucketProtectionConfigurationCommand";
import {
...
} from "./commands/PutBucketProtectionConfigurationCommand";
import {
...
} from "./commands/PutBucketReplicationReattemptCommand";
import {
...
export interface S3 {
  ...
  /**
   * @see {@link AddLegalHoldCommand}
   */
  addLegalHold(
    args: AddLegalHoldCommandInput,
    options?: __HttpHandlerOptions
  ): Promise<AddLegalHoldCommandOutput>;
  addLegalHold(
    args: AddLegalHoldCommandInput,
    cb: (err: any, data?: AddLegalHoldCommandOutput) => void
  ): void;
  addLegalHold(
    args: AddLegalHoldCommandInput,
    options: __HttpHandlerOptions,
  ...
  /**
   * @see {@link DeleteLegalHoldCommand}
   */
  deleteLegalHold(
    args: DeleteLegalHoldCommandInput,
    options?: __HttpHandlerOptions
  ): Promise<DeleteLegalHoldCommandOutput>;
  deleteLegalHold(
    args: DeleteLegalHoldCommandInput,
    cb: (err: any, data?: DeleteLegalHoldCommandOutput) => void
  ): void;
  deleteLegalHold(
    args: DeleteLegalHoldCommandInput,
    options: __HttpHandlerOptions,
  ...
  /**
   * @see {@link GetBucketProtectionConfigurationCommand}
   */
  getBucketProtectionConfiguration(
    args: GetBucketProtectionConfigurationCommandInput,
    options?: __HttpHandlerOptions
  ): Promise<GetBucketProtectionConfigurationCommandOutput>;
  getBucketProtectionConfiguration(
    args: GetBucketProtectionConfigurationCommandInput,
    cb: (err: any, data?: GetBucketProtectionConfigurationCommandOutput) => void
  ): void;
  getBucketProtectionConfiguration(
    args: GetBucketProtectionConfigurationCommandInput,
    options: __HttpHandlerOptions,
  ...
  /**
   * @see {@link ListBucketReplicationFailuresCommand}
   */
  listBucketReplicationFailures(
    args: ListBucketReplicationFailuresCommandInput,
    options?: __HttpHandlerOptions
  ): Promise<ListBucketReplicationFailuresCommandOutput>;
  listBucketReplicationFailures(
    args: ListBucketReplicationFailuresCommandInput,
    cb: (err: any, data?: ListBucketReplicationFailuresCommandOutput) => void
  ): void;
  listBucketReplicationFailures(
    args: ListBucketReplicationFailuresCommandInput,
    options: __HttpHandlerOptions,
  ...
  /**
   * @see {@link ListBucketsExtendedCommand}
   */
  listBucketsExtended(): Promise<ListBucketsExtendedCommandOutput>;
  listBucketsExtended(
    args: ListBucketsExtendedCommandInput,
    options?: __HttpHandlerOptions
  ): Promise<ListBucketsExtendedCommandOutput>;
  listBucketsExtended(
    args: ListBucketsExtendedCommandInput,
    cb: (err: any, data?: ListBucketsExtendedCommandOutput) => void
  ): void;
  listBucketsExtended(
    args: ListBucketsExtendedCommandInput,
    options: __HttpHandlerOptions,
  ...
  /**
   * @see {@link PutBucketProtectionConfigurationCommand}
   */
  putBucketProtectionConfiguration(
    args: PutBucketProtectionConfigurationCommandInput,
    options?: __HttpHandlerOptions
  ): Promise<PutBucketProtectionConfigurationCommandOutput>;
  putBucketProtectionConfiguration(
    args: PutBucketProtectionConfigurationCommandInput,
    cb: (err: any, data?: PutBucketProtectionConfigurationCommandOutput) => void
  ): void;
  putBucketProtectionConfiguration(
    args: PutBucketProtectionConfigurationCommandInput,
    options: __HttpHandlerOptions,
  ...
  /**
   * @see {@link PutBucketReplicationReattemptCommand}
   */
  putBucketReplicationReattempt(
    args: PutBucketReplicationReattemptCommandInput,
    options?: __HttpHandlerOptions
  ): Promise<PutBucketReplicationReattemptCommandOutput>;
  putBucketReplicationReattempt(
    args: PutBucketReplicationReattemptCommandInput,
    cb: (err: any, data?: PutBucketReplicationReattemptCommandOutput) => void
  ): void;
  putBucketReplicationReattempt(
    args: PutBucketReplicationReattemptCommandInput,
    options: __HttpHandlerOptions,
