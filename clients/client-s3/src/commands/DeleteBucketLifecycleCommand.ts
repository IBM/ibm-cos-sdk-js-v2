 ...
 * ```javascript
 * import { S3Client, DeleteBucketLifecycleCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketLifecycleCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
