 ...
 * ```javascript
 * import { S3Client, GetBucketLoggingCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketLoggingCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
