 ...
 * ```javascript
 * import { S3Client, DeleteBucketWebsiteCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketWebsiteCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
