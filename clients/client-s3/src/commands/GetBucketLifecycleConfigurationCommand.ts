 ...
 * ```javascript
 * import { S3Client, GetBucketLifecycleConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketLifecycleConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
