...
import type { PutObjectRetentionOutput, PutObjectRetentionRequest } from "../models/models_1";
 ...
 * ```javascript
 * import { S3Client, PutObjectRetentionCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutObjectRetentionCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
