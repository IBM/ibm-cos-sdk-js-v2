 ...
 * ```javascript
 * import { S3Client, PutPublicAccessBlockCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutPublicAccessBlockCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
