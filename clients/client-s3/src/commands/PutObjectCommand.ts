...
import { getCheckContentLengthHeaderPlugin, getThrow200ExceptionsPlugin } from "@ibm-cos/middleware-sdk-s3";
 ...
 * ```javascript
 * import { S3Client, PutObjectCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutObjectCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
