 ...
 * ```javascript
 * import { S3Client, GetBucketInventoryConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketInventoryConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
