 ...
 * ```javascript
 * import { S3Client, UploadPartCopyCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, UploadPartCopyCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
