 ...
 * ```javascript
 * import { S3Client, PutBucketReplicationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketReplicationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
