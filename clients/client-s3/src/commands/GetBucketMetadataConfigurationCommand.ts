 ...
 * ```javascript
 * import { S3Client, GetBucketMetadataConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketMetadataConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
