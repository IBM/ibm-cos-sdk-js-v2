 ...
 * ```javascript
 * import { S3Client, PutBucketWebsiteCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketWebsiteCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
