 ...
 * ```javascript
 * import { S3Client, PutBucketVersioningCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketVersioningCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
