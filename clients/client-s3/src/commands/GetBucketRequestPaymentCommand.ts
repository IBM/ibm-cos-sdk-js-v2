 ...
 * ```javascript
 * import { S3Client, GetBucketRequestPaymentCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketRequestPaymentCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
