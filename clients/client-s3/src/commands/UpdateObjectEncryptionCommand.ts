 ...
 * ```javascript
 * import { S3Client, UpdateObjectEncryptionCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, UpdateObjectEncryptionCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
