 ...
 * ```javascript
 * import { S3Client, DeleteBucketOwnershipControlsCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketOwnershipControlsCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
