 ...
 * ```javascript
 * import { S3Client, GetBucketWebsiteCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketWebsiteCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
