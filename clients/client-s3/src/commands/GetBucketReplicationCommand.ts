 ...
 * ```javascript
 * import { S3Client, GetBucketReplicationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketReplicationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
