 ...
 * ```javascript
 * import { S3Client, DeleteBucketReplicationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketReplicationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
