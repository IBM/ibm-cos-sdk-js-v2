 ...
 * ```javascript
 * import { S3Client, GetObjectRetentionCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetObjectRetentionCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
