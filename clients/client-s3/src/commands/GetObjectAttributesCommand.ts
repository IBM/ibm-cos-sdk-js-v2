 ...
 * ```javascript
 * import { S3Client, GetObjectAttributesCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetObjectAttributesCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
