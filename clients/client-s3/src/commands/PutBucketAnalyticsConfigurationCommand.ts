 ...
 * ```javascript
 * import { S3Client, PutBucketAnalyticsConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketAnalyticsConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
