 ...
 * ```javascript
 * import { S3Client, DeleteBucketMetricsConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketMetricsConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
