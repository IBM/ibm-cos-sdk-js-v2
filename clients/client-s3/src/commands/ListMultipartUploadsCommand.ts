 ...
 * ```javascript
 * import { S3Client, ListMultipartUploadsCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, ListMultipartUploadsCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
