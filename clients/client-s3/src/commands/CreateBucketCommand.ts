...
import { getLocationConstraintPlugin } from "@ibm-cos/middleware-location-constraint";
 ...
 * ```javascript
 * import { S3Client, CreateBucketCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, CreateBucketCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
