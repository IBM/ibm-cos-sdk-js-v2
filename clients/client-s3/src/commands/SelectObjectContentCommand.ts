 ...
 * ```javascript
 * import { S3Client, SelectObjectContentCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, SelectObjectContentCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
