 ...
 * ```javascript
 * import { S3Client, AbortMultipartUploadCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, AbortMultipartUploadCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
