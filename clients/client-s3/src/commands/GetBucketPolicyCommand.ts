 ...
 * ```javascript
 * import { S3Client, GetBucketPolicyCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketPolicyCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
