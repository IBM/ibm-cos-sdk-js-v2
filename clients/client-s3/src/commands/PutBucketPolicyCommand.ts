 ...
 * ```javascript
 * import { S3Client, PutBucketPolicyCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketPolicyCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
