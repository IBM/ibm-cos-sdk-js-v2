 ...
 * ```javascript
 * import { S3Client, DeleteBucketMetadataConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketMetadataConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
