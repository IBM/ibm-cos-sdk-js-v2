 ...
 * ```javascript
 * import { S3Client, GetPublicAccessBlockCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetPublicAccessBlockCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
