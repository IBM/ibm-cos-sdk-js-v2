 ...
 * ```javascript
 * import { S3Client, DeleteBucketTaggingCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketTaggingCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
