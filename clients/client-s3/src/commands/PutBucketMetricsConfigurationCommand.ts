 ...
 * ```javascript
 * import { S3Client, PutBucketMetricsConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketMetricsConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
