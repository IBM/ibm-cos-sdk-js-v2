 ...
 * ```javascript
 * import { S3Client, PutBucketRequestPaymentCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketRequestPaymentCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
