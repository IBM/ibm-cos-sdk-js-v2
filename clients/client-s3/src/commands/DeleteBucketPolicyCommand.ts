 ...
 * ```javascript
 * import { S3Client, DeleteBucketPolicyCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketPolicyCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
