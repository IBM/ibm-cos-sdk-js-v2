 ...
 * ```javascript
 * import { S3Client, PutBucketOwnershipControlsCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketOwnershipControlsCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
