...
import { getS3ExpiresMiddlewarePlugin, getThrow200ExceptionsPlugin } from "@ibm-cos/middleware-sdk-s3";
import { getSsecPlugin } from "@ibm-cos/middleware-ssec";
 ...
 * ```javascript
 * import { S3Client, HeadObjectCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, HeadObjectCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
 ...
 * // { // HeadObjectOutput
 * //   TemporaryCopyStorageClass: "STRING_VALUE",
 * //   Transition: "STRING_VALUE",
 * //   RetentionLegalHoldCount: Number("int"),
