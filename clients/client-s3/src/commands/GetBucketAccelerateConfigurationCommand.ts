 ...
 * ```javascript
 * import { S3Client, GetBucketAccelerateConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketAccelerateConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
