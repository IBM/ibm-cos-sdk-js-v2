 ...
 * ```javascript
 * import { S3Client, GetBucketEncryptionCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketEncryptionCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
