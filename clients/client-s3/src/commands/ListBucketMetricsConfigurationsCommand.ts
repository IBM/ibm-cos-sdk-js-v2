 ...
 * ```javascript
 * import { S3Client, ListBucketMetricsConfigurationsCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, ListBucketMetricsConfigurationsCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
