...
import type { PutObjectLegalHoldOutput } from "../models/models_0";
import type { PutObjectLegalHoldRequest } from "../models/models_1";
 ...
 * ```javascript
 * import { S3Client, PutObjectLegalHoldCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutObjectLegalHoldCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
