 ...
 * ```javascript
 * import { S3Client, PutBucketAccelerateConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketAccelerateConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
