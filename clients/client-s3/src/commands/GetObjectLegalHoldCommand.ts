 ...
 * ```javascript
 * import { S3Client, GetObjectLegalHoldCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetObjectLegalHoldCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
