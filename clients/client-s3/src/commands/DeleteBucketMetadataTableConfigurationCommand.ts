 ...
 * ```javascript
 * import { S3Client, DeleteBucketMetadataTableConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketMetadataTableConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
