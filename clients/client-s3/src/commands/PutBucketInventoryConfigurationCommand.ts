 ...
 * ```javascript
 * import { S3Client, PutBucketInventoryConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketInventoryConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
