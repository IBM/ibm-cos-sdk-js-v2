 ...
 * ```javascript
 * import { S3Client, PutBucketEncryptionCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketEncryptionCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
