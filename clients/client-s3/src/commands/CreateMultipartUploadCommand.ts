 ...
 * ```javascript
 * import { S3Client, CreateMultipartUploadCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, CreateMultipartUploadCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
