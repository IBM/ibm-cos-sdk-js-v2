 ...
 * ```javascript
 * import { S3Client, GetBucketPolicyStatusCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketPolicyStatusCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
