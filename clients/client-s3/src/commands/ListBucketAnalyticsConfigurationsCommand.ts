 ...
 * ```javascript
 * import { S3Client, ListBucketAnalyticsConfigurationsCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, ListBucketAnalyticsConfigurationsCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
