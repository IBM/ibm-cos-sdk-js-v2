 ...
 * ```javascript
 * import { S3Client, PutBucketLifecycleConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketLifecycleConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
