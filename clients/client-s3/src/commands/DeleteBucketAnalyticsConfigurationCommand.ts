 ...
 * ```javascript
 * import { S3Client, DeleteBucketAnalyticsConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketAnalyticsConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
