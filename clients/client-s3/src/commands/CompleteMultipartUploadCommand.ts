 ...
 * ```javascript
 * import { S3Client, CompleteMultipartUploadCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, CompleteMultipartUploadCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
