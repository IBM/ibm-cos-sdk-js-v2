 ...
 * ```javascript
 * import { S3Client, DeleteObjectTaggingCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteObjectTaggingCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
