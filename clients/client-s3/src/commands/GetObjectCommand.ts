...
import { getS3ExpiresMiddlewarePlugin } from "@ibm-cos/middleware-sdk-s3";
 ...
 * ```javascript
 * import { S3Client, GetObjectCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetObjectCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
