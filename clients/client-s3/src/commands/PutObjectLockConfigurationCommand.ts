...
import type { PutObjectLockConfigurationOutput, PutObjectLockConfigurationRequest } from "../models/models_1";
 ...
 * ```javascript
 * import { S3Client, PutObjectLockConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutObjectLockConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
