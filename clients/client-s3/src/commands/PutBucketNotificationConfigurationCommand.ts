 ...
 * ```javascript
 * import { S3Client, PutBucketNotificationConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketNotificationConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
