 ...
 * ```javascript
 * import { S3Client, DeleteBucketInventoryConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketInventoryConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
