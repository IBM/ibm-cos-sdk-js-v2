 ...
 * ```javascript
 * import { S3Client, DeleteBucketCorsCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, DeleteBucketCorsCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
