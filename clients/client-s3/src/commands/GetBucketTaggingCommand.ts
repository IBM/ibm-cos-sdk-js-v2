 ...
 * ```javascript
 * import { S3Client, GetBucketTaggingCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketTaggingCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
