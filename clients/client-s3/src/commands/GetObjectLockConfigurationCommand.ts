 ...
 * ```javascript
 * import { S3Client, GetObjectLockConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetObjectLockConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
