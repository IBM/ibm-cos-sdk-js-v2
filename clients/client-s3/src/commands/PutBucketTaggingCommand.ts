 ...
 * ```javascript
 * import { S3Client, PutBucketTaggingCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, PutBucketTaggingCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
