 ...
 * ```javascript
 * import { S3Client, GetBucketLocationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketLocationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
