 ...
 * ```javascript
 * import { S3Client, ListBucketInventoryConfigurationsCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, ListBucketInventoryConfigurationsCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
