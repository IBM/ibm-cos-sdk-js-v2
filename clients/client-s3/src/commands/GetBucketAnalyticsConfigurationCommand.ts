 ...
 * ```javascript
 * import { S3Client, GetBucketAnalyticsConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketAnalyticsConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
