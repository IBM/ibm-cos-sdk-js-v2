 ...
 * ```javascript
 * import { S3Client, GetBucketNotificationConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketNotificationConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
