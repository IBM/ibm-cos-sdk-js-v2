 ...
 * ```javascript
 * import { S3Client, GetObjectTaggingCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetObjectTaggingCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
