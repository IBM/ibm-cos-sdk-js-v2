 ...
 * ```javascript
 * import { S3Client, GetBucketMetadataTableConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketMetadataTableConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
