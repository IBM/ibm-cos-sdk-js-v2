 ...
 * ```javascript
 * import { S3Client, GetBucketOwnershipControlsCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, GetBucketOwnershipControlsCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
