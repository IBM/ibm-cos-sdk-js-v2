 ...
 * ```javascript
 * import { S3Client, UpdateBucketMetadataInventoryTableConfigurationCommand } from "ibm-cos-sdk-v2"; // ES Modules import
 * // const { S3Client, UpdateBucketMetadataInventoryTableConfigurationCommand } = require("ibm-cos-sdk-v2"); // CommonJS import
