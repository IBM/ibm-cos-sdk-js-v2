...
import { iamCredentialProvider } from "@ibm-cos/credential-provider-iam";
import { getAddExpectContinuePlugin } from "@ibm-cos/middleware-expect-continue";
import {
  type FlexibleChecksumsInputConfig,
  type FlexibleChecksumsResolvedConfig,
  resolveFlexibleChecksumsConfig,
} from "@ibm-cos/middleware-flexible-checksums";
import {
  type HostHeaderInputConfig,
  type HostHeaderResolvedConfig,
  getHostHeaderPlugin,
  resolveHostHeaderConfig,
} from "@ibm-cos/middleware-host-header";
import { getLoggerPlugin } from "@ibm-cos/middleware-logger";
import { getRecursionDetectionPlugin } from "@ibm-cos/middleware-recursion-detection";
import {
  ...
  S3InputConfig,
  S3ResolvedConfig,
} from "@ibm-cos/middleware-sdk-s3";
import {
  type UserAgentInputConfig,
  type UserAgentResolvedConfig,
  getUserAgentPlugin,
  resolveUserAgentConfig,
} from "@ibm-cos/middleware-user-agent";
import { GetAwsChunkedEncodingStream } from "@ibm-cos/types";
...
import { AddLegalHoldCommandInput, AddLegalHoldCommandOutput } from "./commands/AddLegalHoldCommand";
import {
...
import { DeleteLegalHoldCommandInput, DeleteLegalHoldCommandOutput } from "./commands/DeleteLegalHoldCommand";
