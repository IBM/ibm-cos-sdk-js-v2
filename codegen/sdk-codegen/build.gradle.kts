...
val buildSdk = tasks.register<SmithyBuildTask>("buildSdk") {
    smithyBuildConfigs.set(files("smithy-build-s3.json"))
    outputDir.set(file("build-single/s3"))
}
...
abstract class GenerateSmithyBuildTask : DefaultTask() {
    ...
    fun generate() {
        ...
        val file = File(modelsDirFile, "s3.json")
        ...
        val projectionContents = Node.objectNodeBuilder()
                ...
                .withMember("plugins", Node.objectNode()
                        .withMember("typescript-codegen", Node.objectNodeBuilder()
                                .withMember("package", if (sdkId == "s3") "ibm-cos-sdk-v2" else "@ibm-cos/client-" + sdkId.lowercase())
                                ...
                                .withMember("packageDescription", "IBM COS SDK for JavaScript "
...
val generateSmithyBuild = tasks.register<GenerateSmithyBuildTask>("generate-smithy-build") {
    ...
    buildFile.set(layout.projectDirectory.file("smithy-build-s3.json"))
}
