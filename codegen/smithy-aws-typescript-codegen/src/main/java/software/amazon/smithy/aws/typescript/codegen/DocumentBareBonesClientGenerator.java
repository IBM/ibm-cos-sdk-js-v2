...
final class DocumentBareBonesClientGenerator implements Runnable {
    ...
    public void run() {
        ...
        writer.write("""
                     ...
                     } from "@ibm-cos/client-dynamodb";
                     import { marshallOptions, unmarshallOptions } from "@ibm-cos/util-dynamodb";
                     """);
            ...
            () -> {
                ...
                writer.write("""
                             if (this.config?.cacheMiddleware) {
                                 throw new Error(
                                     "@ibm-cos/lib-dynamodb - cacheMiddleware=true is not compatible with the"
