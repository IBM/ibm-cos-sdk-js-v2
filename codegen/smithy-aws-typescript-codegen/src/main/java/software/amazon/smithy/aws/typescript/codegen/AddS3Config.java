...
public final class AddS3Config implements TypeScriptIntegration {
    ...
    private static final String CRT_NOTIFICATION = "<p>Note: To supply the Multi-region Access Point (MRAP) to Bucket,"
        + " you need to install the \"@ibm-cos/signature-v4-crt\" package to your project dependencies. \n"
    ...
    public Model preprocessModel(Model model, TypeScriptSettings settings) {
        ...
        if (expiresShapeIsPresent) {
            ...
            // for any output shape member targeting Expires, add a member ExpiresString
            // targeting ExpiresString.
            ...
            // SDK middleware will take care of copying expires header to expiresstring
            // header prior to deserialization.
            for (OperationShape operationShape : topDownIndex.getContainedOperations(serviceShape)) {
    ...
    public List<RuntimeClientPlugin> getClientPlugins() {
        return ListUtils.of(
            ...
            RuntimeClientPlugin.builder()
                ...
                .build(),
            /*
             * BUCKET_ENDPOINT_MIDDLEWARE needs two separate plugins. The first resolves the
