import { SignatureV4S3Express } from "@ibm-cos/middleware-sdk-s3";
import {
  ...
  public async signWithCredentials(
    ...
    if (options.signingRegion === "*") {
      ...
      if (CrtSignerV4 && signer instanceof CrtSignerV4) {
        ...
        throw new Error(
          `signWithCredentials with signingRegion '*' is only supported when using the CRT dependency @ibm-cos/signature-v4-crt. ` +
            `Please check whether you have installed the "@ibm-cos/signature-v4-crt" package explicitly. ` +
            `You must also register the package by calling [require("@ibm-cos/signature-v4-crt");] ` +
            `or an ESM equivalent such as [import "@ibm-cos/signature-v4-crt";]. ` +
  ...
  public async presign(originalRequest: HttpRequest, options: RequestPresigningArguments = {}): Promise<HttpRequest> {
    if (options.signingRegion === "*") {
      ...
      if (CrtSignerV4 && signer instanceof CrtSignerV4) {
        ...
        throw new Error(
          `presign with signingRegion '*' is only supported when using the CRT dependency @ibm-cos/signature-v4-crt. ` +
            `Please check whether you have installed the "@ibm-cos/signature-v4-crt" package explicitly. ` +
            `You must also register the package by calling [require("@ibm-cos/signature-v4-crt");] ` +
            `or an ESM equivalent such as [import "@ibm-cos/signature-v4-crt";]. ` +
            `For more information please go to https://github.com/aws/aws-sdk-js-v3#functionality-requiring-aws-common-runtime-crt`
        ...
        if (!CrtSignerV4 && !JsSigV4aSigner) {
          throw new Error(
            "Neither CRT nor JS SigV4a implementation is available. " +
              "Please load either @ibm-cos/signature-v4-crt or @ibm-cos/signature-v4a. " +
        ...
        if (CrtSignerV4 && typeof CrtSignerV4 === "function") {
          ...
          throw new Error(
            "Available SigV4a implementation is not a valid constructor. " +
              "Please ensure you've properly imported @ibm-cos/signature-v4-crt or @ibm-cos/signature-v4a." +
              "For more information please go to " +
              "https://github.com/aws/aws-sdk-js-v3#functionality-requiring-aws-common-runtime-crt"
          );
        }
        ...
        if (!JsSigV4aSigner || typeof JsSigV4aSigner !== "function") {
          throw new Error(
            "JS SigV4a implementation is not available or not a valid constructor. " +
              "Please check whether you have installed the @ibm-cos/signature-v4a package explicitly. The CRT implementation is not available for browsers. " +
              "You must also register the package by calling [require('@ibm-cos/signature-v4a');] " +
              "or an ESM equivalent such as [import '@ibm-cos/signature-v4a';]. " +
              "For more information please go to " +
