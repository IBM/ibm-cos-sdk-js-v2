...
vi.mock("@ibm-cos/signature-v4a");
vi.mock("@ibm-cos/middleware-sdk-s3");
vi.mock("@ibm-cos/signature-v4-crt");

import { SignatureV4S3Express } from "@ibm-cos/middleware-sdk-s3";
import { CrtSignerV4 } from "@ibm-cos/signature-v4-crt";
import { SignatureV4a } from "@ibm-cos/signature-v4a";
