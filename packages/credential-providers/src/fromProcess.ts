import { fromProcess as _fromProcess, FromProcessInit } from "@ibm-cos/credential-provider-process";
 ...
 *
 * ```javascript
 * import { fromProcess } from "@ibm-cos/credential-providers"; // ES6 import
 * // const { fromProcess } = require("@ibm-cos/credential-providers"); // CommonJS import
 *
