import { defaultProvider, DefaultProviderInit } from "@ibm-cos/credential-provider-node";
 ...
 *
 * ```js
 * import { fromNodeProviderChain } from "@ibm-cos/credential-providers"; // ES6 import
 * // const { fromNodeProviderChain } = require("@ibm-cos/credential-providers") // CommonJS import
 *
