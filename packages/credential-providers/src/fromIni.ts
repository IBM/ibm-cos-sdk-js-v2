import { fromIni as _fromIni, FromIniInit } from "@ibm-cos/credential-provider-ini";
import type { RuntimeConfigAwsCredentialIdentityProvider } from "@ibm-cos/types";
 ...
 *
 * ```javascript
 * import { fromIni } from "@ibm-cos/credential-providers"; // ES6 import
 * // const { fromIni } = require("@ibm-cos/credential-providers"); // CommonJS import
 *
